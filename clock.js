...
Module.register("clock", {
	...
	defaults: {
		...
		showWeek: false,
		dateFormat: "dddd, LL",
		//dateFormat: "dddd,[</br>]LL",	//edit by hsiang
	...
	getDom: function () {
		...
		//dateWrapper.className = "date normal large";	//edit by hsiang
		...
		secondsWrapper.innerHTML = now.format("\xa0ss\xa0"); //edit by hsiang
		...
		if (this.config.displayType !== "digital") {
			...
			clockHour.id = "clockHour";//add by hsiang
		...
		if (this.config.displayType === "digital") {
			...
			dateWrapper.style.paddingBottom = "10px"; //add by hsiang
